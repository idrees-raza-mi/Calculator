...
const units = [
  ...
  { value: 'ms', label: 'Meters per Second (m/s)', symbol: 'm/s' },
  { value: 'knots', label: 'Knots (kn)', symbol: 'kn' },
];
...
export default function SpeedConverter() {
  ...
  const saveCurrentCalculation = () => {
    if (fromValue && toValue) {
      ...
      saveCalculation('speed', calculation);
      setRecentCalculations(getCalculations('speed'));
    }
  };
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <button
              ...
              disabled={!toValue}
              className="flex items-center space-x-2 px-4 py-2 bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300 rounded-lg hover:bg-yellow-200 dark:hover:bg-yellow-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <span>Save</span>
            </button>
          </div>
