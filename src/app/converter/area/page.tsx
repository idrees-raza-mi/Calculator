...
const units = [
  ...
  { value: 'squareInches', label: 'Square Inches (in²)', symbol: 'in²' },
...
export default function AreaConverter() {
  ...
  const saveCurrentCalculation = () => {
    if (fromValue && toValue) {
      ...
      saveCalculation('area', calculation);
      setRecentCalculations(getCalculations('area'));
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <Square className="h-12 w-12 text-purple-500" />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <button
              ...
              disabled={!toValue}
              className="flex items-center space-x-2 px-4 py-2 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <span>Save</span>
            </button>
          </div>
